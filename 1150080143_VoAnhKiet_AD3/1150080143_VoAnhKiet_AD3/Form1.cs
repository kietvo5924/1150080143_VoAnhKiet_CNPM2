...
namespace _1150080143_VoAnhKiet_AD3
{
    public partial class Form1 : Form
    {
        ...
        string strCon = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\QuanLySinhVien_AD3.mdf;Integrated Security=True";
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                ...
                // Sử dụng Parameter để xóa an toàn
